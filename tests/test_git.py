...
class TestGitRepo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.repo = GitRepo(1, "test", "https://github.com/test/test.git", work_dir=self.temp_dir)
...
class TestGitTracker(unittest.TestCase):
    ...
    def test_add_repository(self, mock_git_repo):
        ...
        # Add the repository
        success = self.tracker.add_repository(1, "test", "https://github.com/test/test.git")
