...
class WebhookHandler:
    ...
    def handle(self, provider: str, headers: Dict[str, str], payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _verify_signature(self, provider: str, headers: Dict[str, str], payload: Dict[str, Any]) -> bool:
        ...
        if provider.lower() == "github":
            ...
            hmac_obj = hmac.new(self.secret.encode("utf-8"), payload_bytes, hashlib.sha256)
    ...
    def _handle_github(self, headers: Dict[str, str], payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        import time
        timestamp = int(time.mktime(datetime.fromisoformat(timestamp.replace("Z", "+00:00")).timetuple()))
    ...
    def _handle_gitlab(self, headers: Dict[str, str], payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _handle_bitbucket(self, headers: Dict[str, str], payload: Dict[str, Any]) -> Optional[Dict[str, Any]]:
